...
public class Ex9_String {
	...
	public static void main(String[] args) {
		...
		System.out.println(str1.indexOf('a'));//str1에서 첫번째 'a'의 인덱스값
		...
		System.out.println(str3.endsWith("day"));//str3가 day로 끝나면 true 대소문자 까지 정확히 맞아햐함
		System.out.println(str1.equals(str2));//str1이 str2와 대소문자까지 같을경우 true
		System.out.println(str1.equalsIgnoreCase(str1));//대소문자 상관없이 철자만 같으면 true
		System.out.println(str1.compareTo(str2));//str1과 str2의 차이(양수값:str1이 더 큰값,음수갑:str2가 더큰값 // 이건 질문 이해가 안가네!!
