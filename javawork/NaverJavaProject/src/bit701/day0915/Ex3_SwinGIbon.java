...
public class Ex3_SwinGIbon extends JFrame implements ActionListener{
	JButton btn1,btn2;
	...
	public Ex3_SwinGIbon(String title) {
	...
	public static void main(String[] args) {
		// TODO Auto-generated method stub
		Ex3_SwinGIbon s=new Ex3_SwinGIbon("버튼");
