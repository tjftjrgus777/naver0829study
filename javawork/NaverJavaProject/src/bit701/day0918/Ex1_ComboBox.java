...
public class Ex1_ComboBox extends JFrame{
	...
	private void setDesign() {
		...
		//p 패널에 라벨 추가
		lblMesasge=new JLabel("Have a Nice Day!!!");
		lblMesasge.setFont(new Font("Comic Sans MS",Font.BOLD,30));
		p.add(lblMesasge);
		...
		rbYellow.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				// TODO Auto-generated method stub
				lblMesasge.setForeground(Color.yellow);
			}
		});
		rbMagenta.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				// TODO Auto-generated method stub
				lblMesasge.setForeground(Color.magenta);
			}
		});
		rbGray.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				// TODO Auto-generated method stub
				lblMesasge.setForeground(Color.gray);
			}
		});
		rbBlue.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				// TODO Auto-generated method stub
				lblMesasge.setForeground(Color.blue);
			}
		});
	}
