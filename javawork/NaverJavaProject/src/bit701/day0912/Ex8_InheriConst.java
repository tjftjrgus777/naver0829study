...
class SuperC
{
	...
	public SuperC() {
		System.out.println("부모 티폴트 생성자 호출");
		name="홍길동";
		age=10;
	}
...
class SubC extends SuperC
{
	...
	SubC()
	{
		//super();//부모의 티폴트 생성자 호출-숨겨져있다(생략가능-단 디폴트인경우만)
...
//	}
	...
	SubC(String name,int age,String hp)
	{
		super(name,age);//부모의 2번째 생성자 호출됨,생략안됨-반드시 첫출
		System.out.println("sub의 세번째 생성자 호출");
		this.hp=hp;
	}
	...
	{
		//부모클래스의 멤버변수가 protected 이므로 패캐지 상관없이 접근 가능
