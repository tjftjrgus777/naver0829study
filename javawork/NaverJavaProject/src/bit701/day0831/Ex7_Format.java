...
public class Ex7_Format {
	...
	public static void main(String[] args) {
		...
		//패턴 2
		SimpleDateFormat dateFormat2 = new SimpleDateFormat("yyyy년MM월dd일 a hh:mm:ss EEEE");//a:오전/오후 EEEE요일길게 hh:12시간
		...
		System.out.println(numberFormat1.format(money));//4.5673890
		
		NumberFormat numberFormat2 = NumberFormat.getCurrencyInstance();// 지역설정된 하폐단위 붙여서 출력
