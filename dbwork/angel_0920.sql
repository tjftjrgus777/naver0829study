...
--삭제
delete from test; --모든 데이타가 삭제되므로 주의한다
rollback;

--num 이 7,9,10 을 삭제하려면
...
rollback; -- DML(insert,delete,update 인경우만 롤백이되구 drop 은 안됨)
---------------------------------------------------------------------
create table person (
...
--java 라는 컬럼을 number 타입으로 추가후 1~100 사이값만 들어오도록 제약조건도 추가
